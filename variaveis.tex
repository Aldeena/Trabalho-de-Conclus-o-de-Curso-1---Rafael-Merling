...
\author{Rafael Josef de Araújo Cordeiro Merling}  % Seu nome
\authorbib{Merling, Rafael} % Seu nome para referência bibliográfica (Sobrenome, Nome)
\title{A Importância da Orquestração dentro da Modern Data Stack} % Título do trabalho
\titleen{The Importance of Orchestration inside the Modern Data Stack} % Título traduzido para inglês
\advisor{Prof. Leandro Batista de Almeida} % Nome do orientador. Lembre-se de prefixar com "Prof. Dr.", "Profª. Drª.", "Prof. Me." ou "Profª. Me."}
...
\universitycampus{Campus Curitib}
...
\evalboardmember{Rafael Josef de Araújo Cordeiro Merling}{Graduando}{Universidade Tecnológica Federal do Paraná}
